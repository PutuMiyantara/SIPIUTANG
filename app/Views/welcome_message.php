...
<div class="wrapper">
  ...
  <div class="content-wrapper" ng-controller="user">
    ...
    <div class="content-header" ng-init="getUser()">
      <button ng-click="openModal('#detailEditUser')">Test Modal</button>
      ...
      <!-- Modal -->
<div class="modal fade" tabindex="1" role="dialog" id="detailEditUser" visible="showModal">
